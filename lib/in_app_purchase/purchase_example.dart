...
class PurchaseExample extends StatefulWidget {
  @override
  State<PurchaseExample> createState() => _PurchaseExampleState();
}

class _PurchaseExampleState extends State<PurchaseExample> {
